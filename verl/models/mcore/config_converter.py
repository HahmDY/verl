...
def hf_to_mcore_config_dense(
    ...
    qkv_bias = True if ("Qwen2ForCausalLM" in hf_config.architectures) or ("Qwen2ForCausalLMWithLMHead" in hf_config.architectures) or ("Qwen2ForSequenceClassification" in hf_config.architectures) or ("InfoRM" in hf_config.architectures) or ("LlamaForSequenceClassification" in hf_config.architectures) else getattr(hf_config, "attention_bias", False)
